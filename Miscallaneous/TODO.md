...
Remaining:
5. Look at the Github and how they implement the model that optimizes with Sharpness Awareness Optimization (SAM) and KL Divergence, and implement that algorithm without copy pasting or having AI write it.
...
7. If you have time, try the fine tuning yourself, maybe with a different model.
